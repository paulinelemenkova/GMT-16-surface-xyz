...
gmt psbasemap -R -J \
    ...
    -B+t"Surface modelling of the topography along the Guatemala Trench" -O -K >> $ps
# Step-12. Add scale
gmt psbasemap -R -J \
...
gmt psconvert SurfaceTMAT.ps -A0.2c -E720 -P -Tj -Z
